export default function SignUp() {
  return (
    <div className="p-5 lg:pl-[57px] lg:pr-[58px]">
      ...
      <p className="mb-[37px] text-base leading-5 lg:text-[24px] lg:leading-[25px]">
      ...
      <div className="mb-[30px] flex h-[85px] w-full cursor-pointer items-center justify-center gap-[7.5px] rounded-[15px] border border-[#EDEAE7]">
        ...
        <span className="text-[25px] font-[500] leading-5">
          Sign up with Google
        </span>
      </div>
      ...
      <p className="mb-[66px] cursor-pointer bg-gradient-to-r from-[#8338EC] to-[#CB38E7] bg-clip-text text-center text-[24px] font-[500] text-transparent underline decoration-[#8338EC] underline-offset-[6px]">
